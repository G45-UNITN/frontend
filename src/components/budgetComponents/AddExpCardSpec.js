...
export default function AddExpCardSpec({show, handleClose, defaultBudgetId}) {
                ...
                <Modal.Body>
                    ...
                    <Form.Group className="mb-3" controlId="budgetId">
                        ...
                        <Form.Select defaultValue={defaultBudgetId} ref={budgetIdRef} value={selectedBudgetId}
                                     onChange={(e) => setSelectedBudgetId(e.target.value)} disabled={true}>
                            <option value={defaultBudgetId}>
                                {budgets.find(budget => budget._id === defaultBudgetId)?.name}
                            </option>
                        </Form.Select>
                    </Form.Group>
